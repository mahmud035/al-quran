...
Define copying and sharing a single ayah: the formatted text contract, clipboard behaviour, the Web Share API path where the browser supports it, and the feedback shown on success and failure.
